...
This repo contains 2 datasets, the first, titled "initial-data-set.csv," contains my initial dataset, exploring the Area Descriptions of 64 districts from the Mapping Inequality The dataset, and combining it with data from the Chicago Health Atlas. The second, titled "final-data-set.csv," contains my final dataset, refining that dataset and expanding it. There is also a file titled "final-data-essay.ipynb" containing a data essay detailing the process for creating this dataset and my analysis after processing the data. Finally, I have included the original files I edited to create this data set.
